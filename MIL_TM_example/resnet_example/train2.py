...
def main():
    ...
    image_path = 'data/original'  # tongue data set path
    train_txt_path = 'train4_t.txt'
    val_txt_path = 'val4_t.txt'
    save_name='Resnet34_t_o_pre_4_2'
    ...
    for epoch in range(EPOCH):
        ...
        for i, (train_data_batch, train_label_batch) in tqdm(enumerate(data_loader_train),
            ...
            train_outputs = model(train_data_batch)
