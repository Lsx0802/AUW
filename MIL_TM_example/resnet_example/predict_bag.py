...
def model_l(path):
    ...
    # load model weights
    weights_path = "Resnet34_i_pre_4_2.pkl"
...
def main():
    ...
    # with open('bag0.txt', "w") as f:
    patient_pred = []
    patient_true = []

    for i in range(len(val0)):
        patient_true.append(0)
    for i in range(len(val1)):
        patient_true.append(1)
    ...
    print("[val] accuracy:{:.4f} precision:{:.4f} recall:{:.4f} f1:{:.4f}  ".format(accuracy, precision, recall, f1))
